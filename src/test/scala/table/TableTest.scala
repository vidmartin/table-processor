...
class TableTest extends FunSuite {
    test("test1") {
        ...
        assert(table.get(TableCellPosition.parse("B1").get).get == ValueTableCell(IntegerTableCellValue(323)))
        assert(table.get(TableCellPosition.parse("C1").get).get == ValueTableCell(IntegerTableCellValue(22)))
        ...
        assert(table.get(TableCellPosition.parse("E2").get).get == ValueTableCell(IntegerTableCellValue(500)))
        assert(table.get(TableCellPosition.parse("A3").get).get == ValueTableCell(IntegerTableCellValue(123)))
        assert(table.get(TableCellPosition.parse("B3").get).isEmpty)
        assert(table.get(TableCellPosition.parse("C3").get).get == ValueTableCell(IntegerTableCellValue(33)))
